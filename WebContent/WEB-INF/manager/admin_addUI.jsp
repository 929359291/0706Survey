...
<body>
	...
	<div class="jumbotron">
		<h4>创建管理员</h4>
		<div class="container">
			<form action="manager/admin/saveAdmin" method="post" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" name="adminPwd" class="form-control" id="adminPwdInput" placeholder="Enter Password">
					</div>
				</div>
				<div class="form-group">
					<label for="adminPwdConfirmInput" class="col-lg-2 control-label">确认</label>
					<div class="col-lg-10">
						<input type="text" name="pwdConfirm" class="form-control" id="adminPwdConfirmInput" placeholder="Confirm Password">
					</div>
				</div>
